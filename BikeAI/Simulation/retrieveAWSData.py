...
#stationID,capacity,regionID,latitude,longitude,name,shortName
cur.execute("select * from stations")
rows = cur.fetchall()
for row in rows:
    print('INSERT INTO stations VALUES (' + str(row[0]) + ',' + str(row[1]) + ',' + str(row[2]) + ',' + str(row[3]) + ',' + str(row[4])+ ',' + str(row[5])+ ',' + str(row[6])+ ')')
...
rows = cur.fetchall()
for row in rows:
    print('INSERT INTO station_status VALUES (' + str(row[0]) + ',' + str(row[1]) + ',' + str(row[2]) + ',' + str(row[3]) + ',' + str(row[4])+ ',' + str(row[5])+ ',' + str(row[6]) + str(row[7])+ ',' +  str(row[8])+ ',' + str(row[9])+ ')')
